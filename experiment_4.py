...
old_params = {'r': 0.12, 'T': 3, 'Kc': 800, 'm': 10, 'phi1': 0.00001, 'phi2': 0.000001, 'S': 100}
new_params = {'r': 0.12, 'T': 3, 'Kc': 500, 'm': 10, 'phi1': 0.00002, 'phi2': 0.0000009, 'S': 100}
o = AlleePopulation(old_params, new_params, 1)

# Run direct simulations and DME
o.runStochasticSimulations(dt = 0.01, t = 2.0)
o.runDME(dt = 0.01, t = 2.0, update='regularised')  # 'plain', 'regularised' or 'fixed_a4'
